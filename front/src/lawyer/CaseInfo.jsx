...
const CaseInfo = () => {
  ...
  if (loading) return (
    <div className="flex justify-center items-center h-screen">
      <div className="text-center">
        ...
        <p className="text-[#1C2C54] text-lg">Cargando información del caso...</p>
      </div>
    </div>
  );
  ...
  return (
    <div className={`bg-white max-w-4xl mx-auto mt-4 p-6 shadow-md rounded-xl border ${isEditing ? 'border-yellow-500 border-2' : 'border-gray-300'}`}>
      ...
      {isEditing && (
        <div className="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 mb-6 rounded">
          <div className="flex items-center">
            ...
            <strong>Modo Edición:</strong> Estás editando este caso. Los cambios se guardarán cuando presiones "Guardar Cambios".
          </div>
        </div>
      )}
      ...
      <div className="flex justify-between items-start mb-4">
        ...
        <div className="flex space-x-2">
          <button 
            ...
            disabled={isEditing}
            className={`px-3 py-1 rounded text-sm ${isEditing ? 'bg-gray-300 text-gray-500 cursor-not-allowed' : 'bg-yellow-600 text-white hover:bg-yellow-700'}`}
          >
            ✏️ Editar
          </button>
          <button 
            ...
            disabled={isEditing}
            className={`px-3 py-1 rounded text-sm ${isEditing ? 'bg-gray-300 text-gray-500 cursor-not-allowed' : 'bg-red-700 text-white hover:bg-red-800'}`}
          >
            🗑️ Eliminar
          </button>
        </div>
      ...
      {!isEditing ? (
        ...
        <form onSubmit={handleInlineSave} className="mb-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 text-sm text-[#1C2C54]">
            ...
            <div>
              <label className="block mb-1 font-medium text-gray-700">Delito</label>
              <input 
                type="text" 
            ...
            <div>
              <label className="block mb-1 font-medium text-gray-700">Cantón</label>
              <input 
                type="text" 
            ...
            <div>
              <label className="block mb-1 font-medium text-gray-700">Tipo de proceso*</label>
              <select 
              ...
              >
                ...
                {['civil', 'penal', 'laboral', 'administrativo','constitucional','contencioso','violencia contra la mujer'].map(tipo => (
            ...
            <div>
              ...
              <select 
                ...
                onChange={(e) => handleInputChange('processStatus', e.target.value)} 
                className="border border-gray-300 p-2 rounded w-full focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500"
              >
            ...
            <div>
              <label className="block mb-1 font-medium text-gray-700">Género del cliente</label>
              <select 
            ...
            <div>
              <label className="block mb-1 font-medium text-gray-700">Edad del cliente</label>
              <input 
                type="number" 
                value={formData.clientAge} 
                onChange={(e) => handleInputChange('clientAge', Number(e.target.value))} 
                className="border border-gray-300 p-2 rounded w-full focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500"
                placeholder="Edad"
              />
            </div>
            ...
            <div>
              <label className="block mb-1 font-medium text-gray-700">Fecha de finalización</label>
              <input 
                type="date" 
            ...
            <div>
              <label className="block mb-1 font-medium text-gray-700">Número de proceso</label>
              <input 
                type="text" 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-8">
        <button onClick={() => navigate('/lawyer/dashboard')} className="flex items-center justify-center bg-indigo-700 text-white px-4 py-2 rounded hover:bg-indigo-800">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
            <path fillRule="evenodd" d="M9.707 16.707a1 1 0 01-1.414 0l-6-6a1 1 0 010-1.414l6-6a1 1 0 011.414 1.414L5.414 9H17a1 1 0 110 2H5.414l4.293 4.293a1 1 0 010 1.414z" clipRule="evenodd" />
          </svg>
          Volver al dashboard
        </button>
        <button onClick={() => navigate(`/lawyer/event-dashboard/${caseId}`)} className="flex items-center justify-center bg-indigo-700 text-white px-4 py-2 rounded hover:bg-indigo-800">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
